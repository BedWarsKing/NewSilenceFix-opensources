...
public class ClientPhysicUtils {
    ...
    public static void doRenderItemPhysic(Entity par1Entity, double x, double y, double z) {
        ...
        if ((itemstack = (item = (EntityItem) par1Entity).getEntityItem()).getItem() != null) {
            ...
            int i = idk(item, x, y - 0.1f, z, ibakedmodel);
    ...
    public static int idk(EntityItem item, double x, double y, double z, IBakedModel p_177077_9_) {
