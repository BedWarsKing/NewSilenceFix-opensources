...
public final class RenderUtil extends MinecraftInstance {
    ...
    public static void autoExhibition(double x, double y, double x1, double y1, double size) {
        ...
        rectangleBordered(x + 2.5, y + 2.5, x1 + size - 2.5, y1 + size - 2.5, 0.5, net.ccbluex.liquidbounce.utils.render.Colors.getColor(61),  net.ccbluex.liquidbounce.utils.Colors.getColor(0));
    }
