...
public final class RenderUtils extends MinecraftInstance {
    ...
    public static void drawShadowWithCustomAlpha(float x, float y, float width, float height, float alpha) {
        drawTexturedRectWithCustomAlpha(x - 9, y - 9, 9, 9, "shadow/paneltopleft", alpha);
        drawTexturedRectWithCustomAlpha(x - 9, y + height, 9, 9, "shadow/panelbottomleft", alpha);
        drawTexturedRectWithCustomAlpha(x + width, y + height, 9, 9, "shadow/panelbottomright", alpha);
        drawTexturedRectWithCustomAlpha(x + width, y - 9, 9, 9, "shadow/paneltopright", alpha);
        drawTexturedRectWithCustomAlpha(x - 9, y, 9, height, "shadow/panelleft", alpha);
        drawTexturedRectWithCustomAlpha(x + width, y, 9, height, "shadow/panelright", alpha);
        drawTexturedRectWithCustomAlpha(x, y - 9, width, 9, "shadow/paneltop", alpha);
        drawTexturedRectWithCustomAlpha(x, y + height, width, 9, "shadow/panelbottom", alpha);
    }
