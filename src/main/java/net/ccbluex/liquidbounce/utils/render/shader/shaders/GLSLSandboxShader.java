...
public class GLSLSandboxShader {
    ...
    public GLSLSandboxShader(String fragmentShaderLocation) throws IOException {
        ...
        glAttachShader(program, createShader(GLSLSandboxShader.class.getResourceAsStream("/assets/minecraft/fdpclient/shader/fragment/passthrough.vsh"), GL_VERTEX_SHADER));
