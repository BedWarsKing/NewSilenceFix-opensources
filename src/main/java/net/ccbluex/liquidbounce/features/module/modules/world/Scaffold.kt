// Nisgutes Premium Hacked Client Made By ChengFeng
...
class Scaffold : Module() {
    ...
    //counter
    private val counterValue = ListValue("Counter", arrayOf("None", "Simple", "Novoline"), "Simple")

    //timer
    private val timerModeValue = ListValue("Timer", arrayOf("None", "Normal", "Dynamic"), "Normal")
    private val timerSpeedValue =
        FloatValue("TimerSpeed", 1.2F, 0.1F, 3.0F).displayable { timerModeValue.get() == "Normal" }
    ...
    private val rotationsValue =
        ListValue("Rotations", arrayOf("None", "Vanilla", "AAC", "Verus", "Matrix", "Custom"), "AAC")
