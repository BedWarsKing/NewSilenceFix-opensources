...
class Radar(x: Double = 5.0, y: Double = 130.0) : Element(x, y) {
    ...
    override fun drawElement(partialTicks: Float): Border {
        ...
        if (!minimapValue.get()) {
            RenderUtil.drawRect(0F, 0F, size, size, Color(backgroundRedValue.get(), backgroundGreenValue.get(),
        ...
        RenderUtil.makeScissorBox(x.toFloat(), y.toFloat(), x.toFloat() + ceil(size), y.toFloat() + ceil(size))
        ...
        RainbowShader.begin(borderRainbowValue.get(), if (rainbowXValue.get() == 0.0F) 0.0F else 1.0F / rainbowXValue.get(),
            ...
            RenderUtil.drawBorder(0F, 0F, size, size, borderStrengthValue.get(), Color(borderRedValue.get(),
            ...
            RenderUtil.glColor(borderRedValue.get(), borderGreenValue.get(), borderBlueValue.get(), borderAlphaValue.get())
