...
class Text(
    ...
    val rectValue = ListValue("Rect", arrayOf("Normal", "RNormal", "OneTap", "Skeet", "LiquidSlient", "None"), "None")
    private val rectExpandValue = FloatValue("RectExpand", 0.3F, 0F, 1F)
    private val lrectAlphaValue = IntegerValue("LiquidSlientAlpha", 100, 0, 255)
