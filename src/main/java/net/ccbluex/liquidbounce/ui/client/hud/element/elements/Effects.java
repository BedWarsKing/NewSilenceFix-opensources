...
public class Effects extends Element {
    ...
    protected Border draw() {
        ...
        for (final PotionEffect potionEffect : mc.thePlayer.getActivePotionEffects()) {
            ...
            final int position = (int) Math.round(potionData.translate.getY() + 5);
...
//            System.out.println(potionData.translate.getY());
            ...
            RenderUtils.drawShadow(0, (int) Math.round(potionData.translate.getY()), 120, 30);
            float posY = (float) (potionData.translate.getY() + 13F);
